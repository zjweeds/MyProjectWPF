...
namespace Controllers.Business
{
    public class ControlService
    {
        ...
        /// <returns></returns>
        public List<String> GetUpdateStringsByModel(List<ControlModer> controls, List<TextBoxExtendModel> textboxextens, List<MoneyPanelExtendModel> moneyExtends)
        {
            List<String> SqlStrings = new List<string>();
            if (controls != null)
            {
                foreach (ControlModer cm in controls)
                {
                    #region 修改时拼SQL
                    if (cm.updateFlage)
                    {
        ...
        /// <param name="moneyExtends"></param>
        /// <returns></returns>
        public List<String> GetAddSqlStringsByModels(List<ControlModer> controls)
        {
            List<String> SqlStrings = new List<string>();
            if (controls != null)
            {
        ...
        /// <param name="moneyExtends"></param>
        /// <returns></returns>
        public bool UpdateControlsByModels(List<ControlModer> controls, List<TextBoxExtendModel> textboxextens, List<MoneyPanelExtendModel> moneyExtends)
        {
        ...
        /// <param name="moneyExtends"></param>
        /// <returns></returns>
        public bool AddControlsByModels(List<ControlModer> controls)
        {
        ...
        /// <returns></returns>
        public bool AddTextBoxByModels(List<ControlModer> cmtexts, List<TextBoxExtendModel> textextends)
        {
            try
            {
                int textCode = 1;
                if (cmtexts != null)
                {
                    foreach (ControlModer cm in cmtexts)
                    {
                        StringBuilder sb = new StringBuilder();
                        sb.Append(" insert  into ControlInfo ( ");
                        sb.Append("                             CTITIID,CTIName,CTType,CTIDefault,CTIIsBorder,CTIIsTransparent, ");
        ...
        /// <returns></returns>
        public bool AddMoneyPanelByModels(List<ControlModer> cmmoneys, List<MoneyPanelExtendModel> MoneyPaneltends)
        {
            try
            {
                int MoneyCode = 1;
                if (cmmoneys != null)
                {
                    foreach (ControlModer cm in cmmoneys)
                    {
                        StringBuilder sb = new StringBuilder();
                        sb.Append(" insert  into ControlInfo ( ");
                        sb.Append("                             CTITIID,CTIName,CTType,CTIDefault,CTIIsBorder,CTIIsTransparent, ");
