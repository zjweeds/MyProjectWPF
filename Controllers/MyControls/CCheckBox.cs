...
namespace Controllers.MyControls
{
    ...
    public partial class CCheckBox : CheckBox
    {
        ...
        //定义一个方法，作为自定义控件CCheckBox的鼠标按下事件的绑定方法
        private void CCheckBox_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        public List<CCheckBox> GetCCheckBoxes(Control control)
        {
        ...
        //自定义控件的鼠标移动事件绑定方法
        private void CCheckBox_MouseMove(object sender, MouseEventArgs e)
        {
            if (isMoving)
            {
                //根据鼠标移动动态地设置控件的位置
        ...
        private void CCheckBox_MouseUp(object sender, MouseEventArgs e)
        {
            isMoving = false;
        }

        private void toolDeleteCCheckBox_Click(object sender, EventArgs e)
        {
